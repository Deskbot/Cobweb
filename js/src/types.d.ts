...
export declare type MiddlewareSpec<K extends string | number | symbol = string | number | symbol> = Record<K, (req?: IncomingMessage) => any>;
export declare type Middleware<M extends MiddlewareSpec<string | number | symbol> = MiddlewareSpec<string | number | symbol>> = {
